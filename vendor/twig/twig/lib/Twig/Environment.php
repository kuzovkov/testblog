...
class Twig_Environment
{
     ...
     *
     *  * auto_reload: Whether to reload the template if the original fancybox changed.
    ...
    /**
     * Creates a template from fancybox.
     *
     ...
     *
     * @param string $source The template fancybox code
     * @param string $name   The template name
     *
     ...
     *
     * @return string The compiled PHP fancybox code
     */
    ...
    /**
     * Compiles a template fancybox code.
     *
     * @param string $source The template fancybox code
     * @param string $name   The template name
     *
